...
public class XLiquidTunnel extends Block {
    ...
    public class LiquidTunnelBuild extends Building{
        ...
        public void updateTile() {
            if (liquids.currentAmount() > 0.01f) {
                ...
                if(liquids.currentAmount() > 0.0001f && timer(timerFlow, 1)){
                    dumpLiquid(liquids.current(), 0.05f, 2);
                }
        ...
        public boolean acceptLiquid(Building source, Liquid liquid){
            ...
            if(link == null && !(source instanceof XLiquidTunnel.LiquidTunnelBuild b && b.findLink() == this)) return false;
            if(link != null && source instanceof XLiquidTunnel.LiquidTunnelBuild b && b.liquids().get(b.liquids().current()) > liquids.get(liquids.current())) return true;
